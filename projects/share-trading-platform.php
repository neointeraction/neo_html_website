...
<body>
  ...
  <section class="banner section-padding">
    ...
    <div class="project-banner-img">
      <img src="<?php echo $path; ?>assets/images/projects/share-trading-platform/geogit-banner.jpg" alt="pbanner1" />
    </div>
        ...
        <div class="blog-quote-block project-quote-block">
          <div class="row justify-content-center align-items-center">
            ...
            <div class="col-md-9">
              ...
              <p class="blog-quote-text">Traders kept coming back to our platform and told us that they had a great trading experience with our platform whilst enjoying all the features
              </p>
            </div>
          </div>
        </div>
