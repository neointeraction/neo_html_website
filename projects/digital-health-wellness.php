...
<body>
  ...
  <section class="banner section-padding">
    ...
    <div class="project-banner-img">
      <img src="<?php echo $path; ?>assets/images/projects/digital-experience/mega-we-care-banner.jpg" alt="banner" />
    </div>
    <div class="project-content-block">
      <div class="container">
        ...
        <div class="overview-block project-section-padding">
          ...
          <p class="p-main-text">MEGA We Care aimed to enhance the user experience of its corporate website, by gaining insights into its target customers for improved brand reach</p>
        ...
        <div class="objective-challenges project-section-padding">
          <div class="row">
            <div class="col-md-6">
              ...
              <p class="project-body-text">The project focused on identifying areas for UX improvements to reduce bounce rates, increase returning visitors, and boost overall user engagement.</p>
            </div>
            <div class="col-md-6">
              <h4 class="project-section-title ps-responsive-margin">Challenges </h4>
              <p class="project-body-text">The UX audit for MEGA We Care’s website faced challenges in understanding diverse user needs, addressing high bounce rates, and enhancing engagement. Key focus areas included improving content effectiveness, optimizing site performance, and ensuring accessibility and digital literacy levels. Balancing business goals with user expectations and benchmarking against industry best practices were also crucial for driving meaningful improvements.
              </p>
            </div>
          </div>
        </div>
        ...
        <div class="solutions-offered project-section-padding">
          ...
          <p class="project-body-text">Our UX audit for MEGA We Care resulted in detailed findings and actionable recommendations across four key areas: Heuristic Evaluation, Usability Testing, Website Performance, and Accessibility. Each category provided insights into usability issues and opportunities for improvement.</p>
            ...
            <div class="row">
              ...
              <div class="col-12 col-md-6 col-lg-3">
                <div class="custom-card">
                  ...
                  <p class="description">
                  Immediate, low-resource improvements focused on resolving critical usability issues, optimizing navigation, enhancing content clarity, and addressing minor performance bottlenecks to reduce bounce rates and improve engagement.
                  </p>
                </div>
              </div>
              <!-- Card 2 -->
              <div class="col-12 col-md-6 col-lg-3">
                <div class="custom-card">
                  ...
                  <p class="description">
                  Long-term UX and performance optimizations, including structural website improvements, refined user flows, enhanced accessibility standards, and data-driven personalization strategies to increase returning visitors and strengthen brand reach.
                  </p>
                </div>
              </div>
            ...
            <div class="row justify-content-center">
              ...
              <div class="col-12 col-md-6">
                <div class="custom-card case-study-card">
                  ...
                  <p class="description">
                  By addressing usability issues and optimizing navigation, users could find relevant information more easily, leading to increased time spent on the site.
                  </p>
                </div>
              </div>
              <!-- Card 2 -->
              <div class="col-12 col-md-6">
                <div class="custom-card case-study-card">
                  ...
                  <p class="description">
                  Quick wins such as content clarity improvements, better calls-to-action, and performance optimizations encouraged users to stay longer and explore further.
                  </p>
                </div>
              </div>
              ...
              <div class="col-12 col-md-6">
                <div class="custom-card case-study-card">
                  ...
                  <p class="description">
                  Ensuring a smoother, faster, and more inclusive experience made the website more user-friendly across different devices, regions, and levels of digital literacy.
                  </p>
                </div>
              </div>
              ...
              <div class="col-12 col-md-6">
                <div class="custom-card case-study-card">
                  ...
                  <p class="description">
                  Strategic enhancements, including refined user flows and personalized content strategies, made the website more compelling for users to revisit.
                  </p>
                </div>
              </div>
              ...
              <div class="col-12 col-md-6">
                <div class="custom-card case-study-card">
                  ...
                  <p class="description">
                  By aligning the website with user expectations and optimizing content for different target demographics, MEGA We Care improved its ability to connect with and retain its audience.
                  </p>
                </div>
              </div>
            </div>
        ...
        <div class="ui-update project-section-padding">
          ...
          <div class="bs-img">
          <img src="<?php echo $path; ?>assets/images/projects/digital-experience/mega-we-care-priority-mapping.jpeg" alt="banner" />
          </div>
          <div class="bs-img">
          <img src="<?php echo $path; ?>assets/images/projects/digital-experience/mega-we-care-audit-findings.jpeg" alt="banner" />
          </div>
        </div>
