...
<?php include $path . 'includes/head-additional-scripts.php'; ?>
    ...
    <link rel="canonical" href="https://www.neointeraction.com/online-tutoring-platform-90-tuition-app" />
    <meta property="og:title" content="Mobile App UX design for 90+ Online Tuition App | Neointeraction Design" />
    ...
    <meta name="twitter:title" content="Mobile App UX design for 90+ Online Tuition App | Neointeraction Design" />
            ...
            <div class="container">
                ...
                <div class="solutions-help project-section-padding">
                    <div class="title-flex">
                        ...
                        <button class="btn btn-custom case-study-webview" data-service="online-tutoring-platform"
                    ...
                    <button class="btn btn-custom case-study-mobview ps-responsive-margin" data-service="online-tutoring-platform"
                                 data-bs-toggle="modal"
                                 data-bs-target="#downloadCaseStudyModal"
                                 data-project-title="<?php echo htmlspecialchars($project_title); ?>"
                                 data-case-study-url="<?php echo htmlspecialchars($case_study_download_url); ?>">
