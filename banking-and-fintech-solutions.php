...
<body>
                        ...
                        <div class="contact-right">
                            ...
                            <form id="contactForm">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea id="lp_designation" name="lp_designation"
                                        class="form-control custom-input"
    ...
    <section class="industry-experience section-padding">
        <div class="container">
            ...
            <p class="wwd-text">At Neointeraction Design, we specialize in creating next-generation digital products for
                online banking, digital payments, trading apps, NBFC platforms, and financial dashboards. We understand
                that your fintech or SaaS product is at the core of your business success, which is why we deliver
                user-focused designs tailored to your unique goals. With deep domain expertise and an innovative
                approach, we craft secure, engaging, and high-performing experiences that build customer trust and drive
                business growth. Partner with us to transform your financial product into a market-leading digital
                solution.
            </p>
            <div class="what-we-do-block section-margin">
                <div class="row">
                    <div class="col-12 col-md-3 col-lg-3">
                        <div class="wwd-item">
                            <img src="<?php echo $path; ?>assets/images/icons/coin.svg"
                                alt="Fintech banking UX design icon" width="40px" height="40px" />
                            <h3 class="wwd-title">Expertise in Fintech and Banking UX Design</h3>
                            <p class="wwd-text">We lead the industry with a profound understanding of digital banking,
                                conversational banking, AI-powered agentic UX, financial planning, and trading
                                solutions. Collaborating with financial professionals, we craft user-centric experiences
                                that build engagement and trust.</p>
                        </div>
                    </div>
                    <div class="col-12 col-md-3 col-lg-3">
                        <div class="wwd-item">
                            <img src="<?php echo $path; ?>assets/images/icons/customer-centric.svg"
                                alt="Customer-centric solutions icone" width="40px" height="40px" />
                            <h3 class="wwd-title">Customer-Centric Solutions</h3>
                            <p class="wwd-text">Our UX/UI designs address the evolving needs of customers and
                                institutions alike. Using an AI-assisted design process, we create intuitive solutions
                                that improve user experiences across digital banking platforms, conversational
                                interfaces, and financial dashboards.</p>
                        </div>
                    </div>
                    <div class="col-12 col-md-3 col-lg-3">
                        <div class="wwd-item">
                            <img src="<?php echo $path; ?>assets/images/icons/research-driven.svg"
                                alt="Research-driven UX approach icon" width="40px" height="40px" />
                            <h3 class="wwd-title">Research-Driven Approach</h3>
                            <p class="wwd-text">Through detailed qualitative research, we uncover pain points in
                                existing fintech processes and translate them into innovative, AI-enhanced digital
                                products. This insight-driven methodology ensures meaningful impact and improved
                                outcomes for users and businesses.</p>
                        </div>
                    </div>

                    <div class="col-12 col-md-3 col-lg-3">
                        <div class="wwd-item">
                            <img src="<?php echo $path; ?>assets/images/icons/calendar-driven.svg"
                                alt="Fintech domain expertise icon" width="40px" height="40px" />
                            <h3 class="wwd-title">Domain Expertise and Guidance</h3>
                            <p class="wwd-text">Our fintech and banking experts provide strategic mentorship throughout
                                the design process, aligning solutions with industry standards and the fast-changing
                                financial landscape to secure long-term success.</p>
                        </div>
                    </div>
                    <div class="col-12 col-md-3 col-lg-3">
                        <div class="wwd-item">
                            <img src="<?php echo $path; ?>assets/images/icons/ui-design.svg"
                                alt="Future-focused design icon" width="40px" height="40px" />
                            <h3 class="wwd-title">Future-Focused Design Solutions</h3>
                            <p class="wwd-text">We anticipate emerging trends and develop scalable, adaptable designs
                                that prepare clients for tomorrow’s challenges, ensuring sustained relevance in the
                                evolving world of digital finance.</p>
                        </div>
                    </div>

                    <div class="col-12 col-md-3 col-lg-3">
                        <div class="wwd-item">
                            <img src="<?php echo $path; ?>assets/images/icons/enterprise.svg"
                                alt="Banking fintech solutions icon" width="40px" height="40px" />
                            <h3 class="wwd-title">Impactful Banking and Fintech Solutions</h3>
                            <p class="wwd-text">From improving digital and conversational banking experiences to
                                implementing AI-powered agentic interfaces for trading and financial planning, we help
                                financial institutions boost efficiency, accessibility, and innovation—driving
                                sustainable growth across markets.</p>
                        </div>
                    </div>
