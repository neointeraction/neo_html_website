...
<body>
    ...
    <!-- navbar  end  -->
    <!-- banner  -->
    <section class="privacy-banner section-padding">
        <div>
            <div class="container">
        ...
        <div class="container">
          ...
          <h4 class="blog-body-title">Welcome to Neointeraction Design’s Privacy Policy</h4>
            ...
            <p class="privacy-text">
                ...
                Neointeraction Design engages with clients to design creative and unique digital experiences. We bring on board 15 years of domain-agnostic design experience that brings great value to your business. With a steadfast mind to solving problems and finding innovative design solutions that are focused primarily on end-to-end user experience as well as responsive user interfaces that assist a smooth workflow.<br>
                It's not just about the look and feels we support. Our team emphasizes goal-oriented functional design that brings a seamless experience to the end-users. In this digital age, we believe user experience design can play a pivotal role in business transformation as well as engaging with your audience and we want to showcase this on a global scale<br>
                To provide You with Our uninterrupted use of the Website, We may collect and, in some circumstances, disclose information about you with your permission. To ensure better protection of Your privacy, We provide this notice explaining Our information collection and disclosure policies, and the choices You make about the way Your information is collected and used.<br>
                Index:<br>
                Personal Information<br>
                Information We Collect<br>
                Our Use Of Your Information<br>
                How Information Is Collected<br>
                External Links on The Platform<br>
                Cookies<br>
                Google Analytics<br>
                Google Adsense<br>
                Your Rights<br>
                Compliances<br>
                Confidentiality<br>
                Other Information Collectors<br>
                Our Disclosure of Your Information<br>
                Accessing, Reviewing and Changing Your Profile<br>
                Security<br>
                Severability<br>
                Amendment<br>
                Consent Withdrawal, Data Download & Data Removal Requests<br>
                Contact Us<br>
                This Privacy Policy shall be in compliance with the General Data Protection Regulation (GDPR) in effect from May 25, 2018, and any and all provisions that may read to the contrary shall be deemed to be void and unenforceable as of that date. If you do not agree with the terms and conditions of our Privacy Policy, including in relation to the manner of collection or use of your information, please do not use or access the Site. If you have any questions or concerns regarding this Privacy Policy, you should contact our Customer Support Desk at info@neointeraction.com.<br>
                ANY CAPITALIZED WORDS USED HENCEFORTH SHALL HAVE THE MEANING ACCORDED TO THEM UNDER THIS AGREEMENT. FURTHER, ALL HEADING USED HEREIN ARE ONLY FOR THE PURPOSE OF ARRANGING THE VARIOUS PROVISIONS OF THE AGREEMENT IN ANY MANNER. NEITHER THE USER NOR THE CREATORS OF THIS PRIVACY POLICY MAY USE THE HEADING TO INTERPRET THE PROVISIONS CONTAINED WITHIN IT IN ANY MANNER.<br>
                INFORMATION WE COLLECT<br>
                We are committed to respecting Your online privacy. We further recognize Your need for appropriate protection and management of any Personal Information You share with us. We may collect the following information:<br>
                a. Personal data including but not limited to Name, Contact No, Email ID.<br>
                b. Information collected through permission derived by the Website for Location access, and storage permissions etc.<br>
                c. Tracking Information such as, but not limited to the IP address of your device and Device ID when connected to the Internet. This information may include the URL that you just came from (whether this URL is on the Website or not), which URL you next go to (whether this URL is on the Website or not), your computer or device browser information, and other information associated with your interaction with the Website;<br>
                d. Details of Website usage for analytics.<br>
                ...
                a. To enable the provision of services opted for by you;<br>
                b. To enable the viewing of content in your interest;<br>
                c. To communicate the necessary account and product-related information from time to time;<br>
                d. To allow you to receive quality customer care services and data Collection;<br>
                e. To comply with applicable laws, rules and regulations;<br>
                Where any service requested by You involves a third party, such information as is reasonably necessary by the Company to carry out Your service request may be shared with such third party. We also do use your contact information to send you offers based on your interests and prior activity and also to view the content preferred by you. The Company may also use contact information internally to direct its efforts for service improvement but shall immediately delete all such information upon withdrawal of your consent for the same through the ‘unsubscribe’ button or through an email to be sent to info@neointeraction.com.<br>
                To the extent possible, we provide You with the option of not divulging any specific information that you wish for us not to collect, store or use. You may also choose not to use a particular service or feature on the Website and opt-out of any non-essential communications from the Website.<br>
                ...
                The information generated by the cookie about your use of the Website, including your IP address, may be transmitted to and stored by Google on servers in the United States. Google may use this information for the purpose of evaluating your use of the Website, compiling reports on Website activity for us and providing other services relating to Website activity and internet usage. Google may also transfer this information to third parties where required to do so by law, or where such third parties process the information on Google's behalf. Google will not associate your IP address with any other data held by Google. By using this Website, you consent to the processing of data about you by Google in the manner and for the purposes set out above. The Google Website contains further information about Analytics and a copy of Google's privacy policy pages.<br>
                GOOGLE ADSENSE<br>
                Google AdSense is a tool that allows Website publishers to deliver advertisements to site visitors in exchange for revenue calculated on a per-click or per-impression basis. To do this, Google uses cookies and tracking technology to deliver ads personalized to a Website user/visitor. In this regard the following terms are specified to the Users:<br>
                a. Third-party vendors, including Google, use cookies to serve ads based on your prior visits to our Website or other Websites.<br>
                b. Google's use of advertising cookies enables us and our partners to serve advertisements to you based on their visit to our Platform and/or other Websites on the Internet.<br>
                c. You may opt-out of personalized advertising by visiting Ads Settings.<br>
                d. All advertisements of third parties on our Website are for informative purposes only and neither the Website nor the Company guarantees or bears liability for the authenticity of the advertisements.<br>
                e. At no point will the Company permit its competitors to advertise on the Website<br>
                f. You may visit the links in the advertisements at your own risk or choose to not accept the cookies permitting third parties to display their advertisements.<br>
                YOUR RIGHTS<br>
                Unless subject to an exemption, you have the following rights concerning your data:<br>
                a. The right to request a copy of your data which we hold about you;<br>
                b. The right to request for any correction to any personal data if it is found to be inaccurate or out of date;<br>
                c. The right to withdraw Your consent to the processing at any time;<br>
                d. The right to object to the processing of personal data;<br>
                e. The right to complain about a supervisory authority.<br>
                f. The right to obtain information as to whether personal data are transferred to a third country or an international organization.<br>
                Where you hold an account with any of our services, you are entitled to a copy of all personal data which we hold concerning you. You are also entitled to request that we restrict how we use your data in your account when you log in.<br>
                COMPLIANCES<br>
                a. Indian Compliances<br>
                i. This legal agreement is an electronic record in terms of the Indian Information Technology Act, 2000 and rules there under as applicable and the amended provisions about electronic records in various statutes as amended by the Indian Information Technology Act, 2000. This electronic record is generated by a computer system and does not require any physical or digital signatures.<br>
                ii. This legal document is published in accordance with the provisions of Rule 3 (1) of the Indian Information Technology (Intermediaries guidelines) Rules, 2011 and Rule 4 of the Information Technology (Reasonable security practices and procedures and sensitive personal data or information) Rules, 2011 of Information Technology Act, 2000 amended through Information Technology Amendment Act, 2008 that require publishing the Terms of Use and practices for access and usage of any functional Website<br>
                b. GDPR Privacy Rights<br>
                The General Data Protection Regulation or GDPR gives certain rights to individuals in relation to their personal data. Accordingly, we are happy to offer transparency and access controls to help Users take advantage of those rights. As available, except as limited under applicable law, the rights afforded to individuals are:<br>
                i. Right of access- the right to be informed of, and request access to, the data we process about you,<br>
                ii. Right to rectification – the right to request that we amend or update your data where it is inaccurate or incomplete,<br>
                iii. Right to erasure- the right to request that we delete your data,<br>
                iv. Right to restrict – the right to request that we temporarily or permanently stop processing all or some of your personal data,<br>
                v. Right to object – the right to object to us processing your personal data on grounds relating to your particular situation. Along with the right to object to your personal data being processed for direct marketing purposes,<br>
                vi. Right to data portability – the right to request a copy of your personal data in electronic format and the right to transmit that personal data for use in another part’s service,<br>
                vii. Right not to be subject to automated decision-making, the right to not be subject to a decision based solely on automated decision making, including profiling, where the decision would have a legal effect on you or produce a similarly significant effect.<br>
                CONFIDENTIALITY<br>
                You further acknowledge that the Website may contain information that is designated confidential by us and that you shall not disclose such information without our prior written consent. Your information is regarded as confidential and therefore will not be divulged to any third party, unless if legally required to do so to the appropriate authorities. We will not sell, share, or rent your personal information to any third party or use your e-mail address for unsolicited mail. Any emails sent by us will only be in connection with the provision of agreed services, and you retain sole discretion to seek for discontinuation of such communications at any point in time.<br>
                OTHER INFORMATION COLLECTORS<br>
                ...
                ACCESSING, REVIEWING AND CHANGING YOUR PROFILE<br>
                You can review and change the information you submitted except Email ID. An option for facilitating such change shall be present on the Website and such change shall be facilitated by the User. If you change any information, we may or may not keep track of your old information. We will not retain in our files information you have requested to remove for certain circumstances, such as to resolve disputes, troubleshoot problems and enforce our terms and conditions. Such prior information shall be completely removed from our databases, including stored ‘back up’ systems. If you believe that any information, we are holding on to you is incorrect or incomplete, or to remove your profile so that others cannot view it, the User needs to remediate, and promptly correct any such incorrect information.<br>
                SECURITY We treat data as an asset that must be protected against loss and unauthorized access. We employ many different security techniques to protect such data from unauthorized access by members inside and outside the Company. We follow generally accepted industry standards to protect the Personal Information submitted to us and information that we have accessed. However, as effective as encryption technology is, no security system is impenetrable. Our Company cannot guarantee the security of our database, nor can we guarantee that information you provide won’t be intercepted while being transmitted to the Company over the Internet.<br>
                SEVERABILITY<br>
                Each paragraph of this Privacy Policy shall be and remain separate from and independent of and severable from all and any other paragraphs herein except where otherwise expressly indicated or indicated by the context of the agreement. The decision or declaration that one or more of the paragraphs are null and void shall not affect the remaining paragraphs of this privacy policy.<br>
                AMENDMENT<br>
                Our Privacy Policy may change from time to time. The most current version of the policy will govern our use of your information and will always be on the Website Any amendments to this Policy shall be deemed as accepted by the User on their continued use of the Website.<br>
                CONSENT WITHDRAWAL, DATA DOWNLOAD & DATA REMOVAL REQUESTS<br>
                To withdraw your consent, or to request the download or delete your data with us for any or all our services at any time, please email to info@neointeraction.com.<br>
                CONTACT US<br>
                If you have any questions or concerns regarding this privacy policy, you should contact us by sending an e-mail to info@neointeraction.com or by writing to us at:<br>
                NEOINTERACTION DESIGN M-98, 2nd Floor, LICHousing Colony, HAL 3rd Stage, Jeevan Bima Nagar, Bengaluru, Karnataka 560075<br>
            </p>
        </div>
    </section>
