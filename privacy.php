        ...
        <div class="container">
          ...
          <h2 class="section-title pt-0">Welcome to Neointeraction Design’s Privacy Policy</h2>
            ...
            <div class="privacy-text">
               <p>The creator of this Privacy Policy ensures a steady commitment to Your privacy with regard to the protection of your invaluable information that you may share across this Website This privacy policy contains information about the Website</p>
               <p> Neointeraction Design engages with clients to design creative and unique digital experiences. We bring on board 15 years of domain-agnostic design experience that brings great value to your business. With a steadfast mind to solving problems and finding innovative design solutions that are focused primarily on end-to-end user experience as well as responsive user interfaces that assist a smooth workflow.</p>
               <p> It's not just about the look and feels we support. Our team emphasizes goal-oriented functional design that brings a seamless experience to the end-users. In this digital age, we believe user experience design can play a pivotal role in business transformation as well as engaging with your audience and we want to showcase this on a global scale
              ...
              <h2>INFORMATION WE COLLECT</h2>
               ...
               <p> Where any service requested by You involves a third party, such information as is reasonably necessary by the Company to carry out Your service request may be shared with such third party. We also do use your contact information to send you offers based on your interests and prior activity and also to view the content preferred by you. The Company may also use contact information internally to direct its efforts for service improvement but shall immediately delete all such information upon withdrawal of your consent for the same through the ‘unsubscribe’ button or through an email to be sent to <a href="mailto:info@neointeraction.com" style="color: #EC1C24;">info@neointeraction.com</a>.</p>
                ...
                <ol>
                    ...
                    <li>Analytical/performance cookies. They allow us to recognize and count the number of visitors and to see how visitors move around our Website when they are using it. This helps us to improve the way our Website works, for example, by ensuring that users are finding what they are looking for easily.
                    </li>
                    <li>Functionality cookies. These are used to recognize you when you return to our Website This enables us to personalize our content for you, greet you by name and remember your preferences (for example, your choice of language or region).</li>
                ...
                <p>Google AdSense is a tool that allows Website publishers to deliver advertisements to site visitors in exchange for revenue calculated on a per-click or per-impression basis. To do this, Google uses cookies and tracking technology to deliver ads personalized to a Website user/visitor. In this regard the following terms are specified to the Users:</p>
                <ol type="a">
               ...
               <p> Where you hold an account with any of our services, you are entitled to a copy of all personal data which we hold concerning you. You are also entitled to request that we restrict how we use your data in your account when you log in.</p>
                ...
                <p>You can review and change the information you submitted except Email ID. An option for facilitating such change shall be present on the Website and such change shall be facilitated by the User. If you change any information, we may or may not keep track of your old information. We will not retain in our files information you have requested to remove for certain circumstances, such as to resolve disputes, troubleshoot problems and enforce our terms and conditions. Such prior information shall be completely removed from our databases, including stored ‘back up’ systems. If you believe that any information, we are holding on to you is incorrect or incomplete, or to remove your profile so that others cannot view it, the User needs to remediate, and promptly correct any such incorrect information.</p>
                <h4>SECURITY</h4>
                <p>We treat data as an asset that must be protected against loss and unauthorized access. We employ many different security techniques to protect such data from unauthorized access by members inside and outside the Company. We follow generally accepted industry standards to protect the Personal Information submitted to us and information that we have accessed. However, as effective as encryption technology is, no security system is impenetrable. Our Company cannot guarantee the security of our database, nor can we guarantee that information you provide won’t be intercepted while being transmitted to the Company over the Internet.</p>
                ...
                <h4>AMENDMENT</h4>
                <p>Our Privacy Policy may change from time to time. The most current version of the policy will govern our use of your information and will always be on the Website Any amendments to this Policy shall be deemed as accepted by the User on their continued use of the Website.</p>
                
                <h4>CONSENT WITHDRAWAL, DATA DOWNLOAD & DATA REMOVAL REQUESTS</h4>
                <p>To withdraw your consent, or to request the download or delete your data with us for any or all our services at any time, please email to <a href="mailto:info@neointeraction.com" style="color: #EC1C24;">info@neointeraction.com</a>.</p>
             
                <h4>CONTACT US</h4>
                <p>If you have any questions or concerns regarding this privacy policy, you should contact us by sending an e-mail to <a href="mailto:info@neointeraction.com" style="color: #EC1C24;">info@neointeraction.com</a> or by writing to us at:<br>
