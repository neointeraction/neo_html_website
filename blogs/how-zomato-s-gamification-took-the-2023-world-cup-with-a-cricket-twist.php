...
<head>
  ...
  <title>How Zomato's Gamification Took the 2023 World Cup with a Cricket Twist</title>
  <meta name="description" content="Zomato leveraged gamification during the 2023 Cricket World Cup to enhance user engagement. This case study explores how they successfully combined food delivery with live cricket updates."/>
  ...
  <meta property="og:image" content="<?php echo $path; ?>assets/images/blog/zomato-gamification-cricket/ree.webp"/>
  ...
  <meta property="article:published_time" content="2024-04-22T10:58:02.450Z"/>
  <meta property="article:modified_time" content="2024-04-22T10:58:02.450Z"/>
  ...
  <meta name="twitter:image" content="<?php echo $path; ?>assets/images/blog/zomato-gamification-cricket/ree.webp"/>
        ...
        <div class="container">
            <div class="blog-body-padding">
                ...
                <ul>
                    ...
                    <li><strong>Prediction Features:</strong> Users could access match schedules, player statistics, and even predict match outcomes to earn rewards.</li>
                    <li><strong>Milestone based Discounts:</strong> Exclusive deals and discounts were offered based on specific cricketing milestones, such as discounts on biryani for centuries scored by the Indian cricket team.</li>
                    <li><strong>Integration of Roanuz Sports Data:</strong> Roanuz Sports Data provided real-time sports data through its comprehensive API, allowing Zomato to access live scores, player stats, and match insights.</li>
                </ul>
                ...
                <p class="blog-body-text"><strong>3. Increase in App Downloads and Order Volumes:</strong> Zomato observed a significant increase in app downloads, order volumes, and user retention during the Cricket World Cup 2023 period. According to Zomato's official blog post, app downloads surged by 20%, while order volumes increased by 18%, indicating the campaign's effectiveness in driving user engagement and transactions.</p>
