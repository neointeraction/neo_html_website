...
<body>
    ...
    <h2 class="blog-body-title">Personalization in user experience design</h2>
    ...
    <h2 class="blog-body-title">Automation in Design Tasks</h2>
    ...
    <h2 class="blog-body-title">Simplifying User Interaction with NLP</h2>
    ...
    <h2 class="blog-body-title">Predictive analytics</h2>
    ...
    <h2 class="blog-body-title">Automated Customer Support</h2>
