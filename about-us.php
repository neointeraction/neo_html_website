    ...
    <section class="demo-video section-padding">
        <div class="container">
            ...
            <div class="video-container section-margin">
                <iframe class="video-iframe" height="650" data-src="https://www.youtube.com/embed/S-gxMxp6tDU?si=3JEtJ7rMe15mKX8f" style="width:100%;border:0;border-radius: 0;" title="YouTube video player" 
                    ...
                    <div class="project-block-item">
                      ...
                      <?php } ?>
                                        ...
                                        <div class="pb-action-btn">
                                            <button class="btn btn-custom read-more-btn" onclick="window.location.href='<?php echo $path; ?>projects/<?php echo $project['link']; ?>'">
                                                Read More
                                            </button>
                                        </div>
                                    </div>
