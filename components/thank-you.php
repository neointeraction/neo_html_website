...
<head>
    ...
    <meta property="og:title"
        content="Neointeraction UX Designs &amp; Front-End Development Blogs | Insights &amp; Innovations" />
    <meta property="og:description"
        content="Craft your brand identity with the expertise of Neointeraction Design  best branding studio in India." />
    ...
    <section class="error-page">
        <div class="container">
            <div class="error-content">
                ...
                <a href="<?php echo $path; ?>index" class="btn-back">Back to Homepage</a>
            </div>
        </div>
    </section>
