...
<html lang="en">
  ...
  <body>
    <!-- navbar  -->
    <navbar class="navbar-container" data-aos="fade-down">
      <div class="container">
        <div class="row">
          <div class="col-12">
            <nav class="navbar navbar-expand-lg custom-navbar">
              <div class="container-fluid p-0">
                ...
                >
                  ...
                  <button class="btn btn-custom ms-lg-3">Submit Enquiry</button>
                </div>
              </div>
            </nav>
          </div>
    ...
    <section class="banner section-padding">
      <div class="container">
        <h1 class="banner-title" data-aos="fade-up">
          We make tech products <span class="highlight">more human</span>
        </h1>
        <button
    ...
    <section class="clients section-padding">
      <div class="container">
        ...
        <div class="scroll-container" data-aos="fade">
      ...
      <div class="container">
        ...
        <div class="row align-items-center justify-content-center py-4">
          <div class="col-12 col-md-8 mb-3 mb-md-0">
            <form class="d-flex newsletter-form flex-column flex-md-row">
